/*Implement the "Falling Rocks" game in the text console. A small dwarf stays at the bottom 
 ...
 sizes and forms constantly fall down and you need to avoid a crash. Rocks are the symbols
    ...
    static void Main()
    {
        ...
        while (true)
        {
            ...
            if (hitted)
            {
                ...
                PrintOnPosition(dwarf.coordX + 1, dwarf.coordY, 'X', ConsoleColor.Red);
                rocks.Clear();
                PrintStringOnPosition(32, 3, "GAME OVER", ConsoleColor.Green);
                PrintStringOnPosition(32, 5, "Press [Enter]", ConsoleColor.Green);
                PrintStringOnPosition(33, 7, "to continue", ConsoleColor.Green);
                speed = 0;
                Console.ReadLine();
            }
            else
